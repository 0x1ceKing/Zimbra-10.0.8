 ...
 * <p>
 * Generated at Sun Sep 27 02:34:08 UTC 2026
 * @private
 */
AjxTimezoneData = {};

AjxTimezoneData.TRANSITION_YEAR = 2026;
...
AjxTimezoneData.TIMEZONE_RULES = [
	...
	{ serverId: "America/Adak", clientId: "America/Adak", score: 100, 
	  standard: { offset: -600, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "HST" },
	  daylight: { offset: -540, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "HDT" }
	},
	...
	{ serverId: "America/Anchorage", clientId: "America/Anchorage", score: 200, 
	  standard: { offset: -540, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "AKST" },
	  daylight: { offset: -480, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "AKDT" }
	},
	{ serverId: "America/Los_Angeles", clientId: "America/Los_Angeles", score: 200, 
	  standard: { offset: -480, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "PST" },
	  daylight: { offset: -420, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "PDT" }
	},
	...
	{ serverId: "America/Denver", clientId: "America/Denver", score: 200, 
	  standard: { offset: -420, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "MST" },
	  daylight: { offset: -360, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "MDT" }
	},
	...
	{ serverId: "America/Chicago", clientId: "America/Chicago", score: 200, 
	  standard: { offset: -360, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "CST" },
	  daylight: { offset: -300, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "CDT" }
	},
	{ serverId: "America/Chihuahua", clientId: "America/Chihuahua", score: 100,  standard: { offset: -360, tzname: "CST" } },
	{ serverId: "America/Guatemala", clientId: "America/Guatemala", score: 100,  standard: { offset: -360 } },
	{ serverId: "America/Mexico_City", clientId: "America/Mexico_City", score: 100,  standard: { offset: -360 } },
	...
	{ serverId: "Pacific/Easter", clientId: "Pacific/Easter", score: 100, 
	  standard: { offset: -360, mon: 4, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 4, 5 ], tzname: "-06/-05" },
	  daylight: { offset: -300, mon: 9, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 9, 13 ], tzname: "-06/-05" }
	},
	...
	{ serverId: "America/Grand_Turk", clientId: "America/Grand_Turk", score: 100, 
	  standard: { offset: -300, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "EST" },
	  daylight: { offset: -240, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "EDT" }
	},
	{ serverId: "America/Havana", clientId: "America/Havana", score: 100, 
	  standard: { offset: -300, mon: 11, week: 1, wkday: 1, hour: 1, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "CST" },
	  daylight: { offset: -240, mon: 3, week: 2, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "CDT" }
	},
	...
	{ serverId: "America/Asuncion", clientId: "America/Asuncion", score: 100, 
	  standard: { offset: -240, mon: 3, week: 4, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 3, 22 ], tzname: "-04/-03" },
	  daylight: { offset: -180, mon: 10, week: 1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 10, 4 ], tzname: "-04/-03" }
	},
	...
	{ serverId: "America/Halifax", clientId: "America/Halifax", score: 100, 
	  standard: { offset: -240, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "AST" },
	  daylight: { offset: -180, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "ADT" }
	},
	{ serverId: "America/Santiago", clientId: "America/Santiago", score: 100, 
	  standard: { offset: -240, mon: 4, week: 1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 4, 5 ], tzname: "-04/-03" },
	  daylight: { offset: -180, mon: 9, week: 2, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 9, 13 ], tzname: "-04/-03" }
	},
	{ serverId: "America/St_Johns", clientId: "America/St_Johns", score: 100, 
	  standard: { offset: -210, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "NST" },
	  daylight: { offset: -150, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "NDT" }
	},
	...
	{ serverId: "America/Miquelon", clientId: "America/Miquelon", score: 100, 
	  standard: { offset: -180, mon: 11, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 11, 1 ], tzname: "-03/-02" },
	  daylight: { offset: -120, mon: 3, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "-03/-02" }
	},
	...
	{ serverId: "Atlantic/Azores", clientId: "Atlantic/Azores", score: 100, 
	  standard: { offset: -60, mon: 10, week: -1, wkday: 1, hour: 1, min: 0, sec: 0, trans: [ 2026, 10, 25 ], tzname: "-01/+00" },
	  daylight: { offset: 0, mon: 3, week: -1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 3, 29 ], tzname: "-01/+00" }
	},
	...
	{ serverId: "Europe/London", clientId: "Europe/London", score: 100, 
	  standard: { offset: 0, mon: 10, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 10, 25 ], tzname: "GMT/BST" },
	  daylight: { offset: 60, mon: 3, week: -1, wkday: 1, hour: 1, min: 0, sec: 0, trans: [ 2026, 3, 29 ], tzname: "GMT/BST" }
	},
	...
	{ serverId: "Africa/Casablanca", clientId: "Africa/Casablanca", score: 100, 
	  standard: { offset: 60, mon: 4, week: 2, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 4, 12 ], tzname: "+01/+00" },
	  daylight: { offset: 0, mon: 3, week: 2, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 3, 8 ], tzname: "+01/+00" }
	},
	{ serverId: "Europe/Belgrade", clientId: "Europe/Belgrade", score: 100, 
	  standard: { offset: 60, mon: 10, week: -1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 10, 25 ], tzname: "CET" },
	  daylight: { offset: 120, mon: 3, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 29 ], tzname: "CEST" }
	},
	...
	{ serverId: "Africa/Cairo", clientId: "Africa/Cairo", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 5, hour: 23, min: 59, sec: 59, trans: [ 2026, 10, 29 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 4, week: -1, wkday: 6, hour: 0, min: 0, sec: 0, trans: [ 2026, 4, 24 ], tzname: "EEST" }
	},
	...
	{ serverId: "Asia/Beirut", clientId: "Asia/Beirut", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 10, 25 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 1, hour: 0, min: 0, sec: 0, trans: [ 2026, 3, 29 ], tzname: "EEST" }
	},
	{ serverId: "Asia/Gaza", clientId: "Asia/Gaza", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 7, hour: 2, min: 0, sec: 0, trans: [ 2026, 10, 31 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 4, week: 3, wkday: 7, hour: 2, min: 0, sec: 0, trans: [ 2026, 4, 18 ], tzname: "EEST" }
	},
	{ serverId: "Asia/Jerusalem", clientId: "Asia/Jerusalem", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 10, 25 ], tzname: "IST" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 6, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 27 ], tzname: "IDT" }
	},
	{ serverId: "Europe/Athens", clientId: "Europe/Athens", score: 200, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 1, hour: 4, min: 0, sec: 0, trans: [ 2026, 10, 25 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 3, 29 ], tzname: "EEST" }
	},
	...
	{ serverId: "Europe/Chisinau", clientId: "Europe/Chisinau", score: 100, 
	  standard: { offset: 120, mon: 10, week: -1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 10, 25 ], tzname: "EET" },
	  daylight: { offset: 180, mon: 3, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 3, 29 ], tzname: "EEST" }
	},
	...
	{ serverId: "Asia/Amman", clientId: "Asia/Amman", score: 100,  standard: { offset: 180, tzname: "+03" } },
	{ serverId: "Asia/Baghdad", clientId: "Asia/Baghdad", score: 100,  standard: { offset: 180, tzname: "+03/+04" } },
	{ serverId: "Asia/Damascus", clientId: "Asia/Damascus", score: 100,  standard: { offset: 180, tzname: "+03" } },
	...
	{ serverId: "Europe/Volgograd", clientId: "Europe/Volgograd", score: 100,  standard: { offset: 180, tzname: "MSK" } },
	{ serverId: "Asia/Tehran", clientId: "Asia/Tehran", score: 100,  standard: { offset: 210, tzname: "+0330/+0430" } },
	...
	{ serverId: "Asia/Almaty", clientId: "Asia/Almaty", score: 100,  standard: { offset: 300, tzname: "+05" } },
	...
	{ serverId: "Australia/Adelaide", clientId: "Australia/Adelaide", score: 100, 
	  standard: { offset: 570, mon: 4, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 4, 5 ], tzname: "ACST" },
	  daylight: { offset: 630, mon: 10, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 10, 4 ], tzname: "ACDT" }
	},
	...
	{ serverId: "Australia/Hobart", clientId: "Australia/Hobart", score: 100, 
	  standard: { offset: 600, mon: 4, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 4, 5 ], tzname: "AEST" },
	  daylight: { offset: 660, mon: 10, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 10, 4 ], tzname: "AEDT" }
	},
	...
	{ serverId: "Australia/Lord_Howe", clientId: "Australia/Lord_Howe", score: 100, 
	  standard: { offset: 630, mon: 4, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 4, 5 ], tzname: "+1030/+11" },
	  daylight: { offset: 660, mon: 10, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 10, 4 ], tzname: "+1030/+11" }
	},
	...
	{ serverId: "Pacific/Norfolk", clientId: "Pacific/Norfolk", score: 100, 
	  standard: { offset: 660, mon: 4, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 4, 5 ], tzname: "+11/+12" },
	  daylight: { offset: 720, mon: 10, week: 1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 10, 4 ], tzname: "+11/+12" }
	},
	...
	{ serverId: "Pacific/Auckland", clientId: "Pacific/Auckland", score: 100, 
	  standard: { offset: 720, mon: 4, week: 1, wkday: 1, hour: 3, min: 0, sec: 0, trans: [ 2026, 4, 5 ], tzname: "NZST" },
	  daylight: { offset: 780, mon: 9, week: -1, wkday: 1, hour: 2, min: 0, sec: 0, trans: [ 2026, 9, 27 ], tzname: "NZDT" }
	},
	{ serverId: "Pacific/Fiji", clientId: "Pacific/Fiji", score: 100,  standard: { offset: 720, tzname: "+12/+13" } },
	{ serverId: "Pacific/Chatham", clientId: "Pacific/Chatham", score: 100, 
	  standard: { offset: 765, mon: 4, week: 1, wkday: 1, hour: 3, min: 45, sec: 0, trans: [ 2026, 4, 5 ], tzname: "+1245/+1345" },
	  daylight: { offset: 825, mon: 9, week: -1, wkday: 1, hour: 2, min: 45, sec: 0, trans: [ 2026, 9, 27 ], tzname: "+1245/+1345" }
	},
	{ serverId: "Pacific/Apia", clientId: "Pacific/Apia", score: 100,  standard: { offset: 780, tzname: "+13/+14" } },
